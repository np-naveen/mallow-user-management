...
import { Card, Flex, Input, Button, Radio, Row, Col, Modal } from "antd";
import { IdcardOutlined, TableOutlined } from "@ant-design/icons";
import { useSelector, useDispatch } from "react-redux";

import { ListCard, UserCardContainer } from "../../Styles";
...
const Home = () => {
  ...
  const { mode, pageNo, userData, modalAction } = useSelector(
    (state) => state.home
  );
    ...
    <div>
      <ListCard>
        ...
        {userData && (
          <>
            {mode === "table" ? (
              <Card>{/* Render table view of userData */}</Card>
            ) : (
              <UserCardContainer>
